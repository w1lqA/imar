...
const ServiceItem = ({ logo, title, page, styles, index}) => {
  ...
  return (
    <Link onClick={scrollToTop} to={`${index===1?`https://imarproject.com/` : `/service${page}`}`} className={`${styles} px-12 flex-col items-center space-y-6 p-6 scale-100 hover:scale-95 hover:opacity-70 transition-all ease-in-out duration-300`}>
